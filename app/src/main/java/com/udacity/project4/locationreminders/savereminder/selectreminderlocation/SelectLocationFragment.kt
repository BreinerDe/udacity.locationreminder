...
class SelectLocationFragment : BaseFragment(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val zoomLevel = 15f
        enableMyLocation()
        fusedLocationClient.lastLocation.addOnSuccessListener(requireActivity()) { lastLocation ->
            lastLocation?.let {
    ...
    private fun showLocationAlertDialog() {
        AlertDialog.Builder(requireContext()).setTitle(R.string.select_location_alert)
            ...
            .setPositiveButton(android.R.string.ok) { _, _ ->
                _viewModel.showToast.value = getString(R.string.location_selected)
    ...
    companion object {
        ...
        private const val LAT_CENTRAL_PARK_NYC = 40.785091
        private const val LNG_CENTRAL_PARK_NYC = -73.968285
        private val FALLBACK_LOCATION = LatLng(LAT_CENTRAL_PARK_NYC, LNG_CENTRAL_PARK_NYC)
